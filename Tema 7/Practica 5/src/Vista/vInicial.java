...
public class vInicial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(tfContrasena, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void bAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAceptarActionPerformed
        Main.aceptar(tfUsuario.getText(),tfContrasena.getText());
    ...
    public void noEresTu(){
        tfUsuario.setText("");
        tfContrasena.setText("");
       
        contador += 1;
        if (contador==3){
            JOptionPane.showMessageDialog(null,"Has excedido el número de intentos");
            Main.salir();
        }
        else{
         JOptionPane.showMessageDialog(null,"Te estoy avisando");
        }
    }
    /**
