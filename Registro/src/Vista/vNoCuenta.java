...
import registro.Ventanas;

/**
 *
 * @author leora
 */
public class vNoCuenta extends javax.swing.JFrame {

    /**
     * Creates new form vNoCuenta
     */
    public vNoCuenta() {
        initComponents();
    }
    ...
    private void bCrearCuentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCrearCuentaActionPerformed
        ...
        Ventanas.borrarVentana("v3");
        Ventanas.moverVentana("v1", 200,0);
        Ventanas.desbloquearVentana("v1");
        String contrasenaString= String.valueOf(tfContrasena.getPassword());
        try {
            vInicioControlador.crearPersona(tfNombre.getText(),tfApellido.getText(),tfEmail.getText(),tfUsuario.getText(),contrasenaString);
        } catch (SQLException ex) {
            Logger.getLogger(vNoCuenta.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(vNoCuenta.class.getName()).log(Level.SEVERE, null, ex);
        }
        Ventanas.mensajeV1(tfUsuario.getText(),tfContrasena.getPassword());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vNoCuenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
